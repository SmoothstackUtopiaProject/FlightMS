...
public class FlightService {
	...
	// public List<Flight> findFlightReferenceData(@Valid Iterable<Flight> flights) {
	...
	// Update
	public Flight update(Integer id, Route routeId, Airplane airplaneId, String dateTime, Integer seatingId,
